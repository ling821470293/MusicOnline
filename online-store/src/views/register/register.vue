<template>
  <div style="margin-top:0px;background: url(../../static/images/register/back.jpg)no-repeat">
...
.bg-box{
    background:url(../../static/images/register/back.jpg) no-repeat center center;
    background-size: 100%;
}
.login-box{
    width:853px;
