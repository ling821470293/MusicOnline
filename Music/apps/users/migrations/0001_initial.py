    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.CharField(max_length=50, verbose_name='用户编号')),
                ('name', models.CharField(max_length=30, verbose_name='用户名')),
                ('psd', models.CharField(max_length=30, verbose_name='密码')),
                ('user_image', models.ImageField(blank=True, null=True, upload_to='users/images/', verbose_name='头像')),
